...
// Base of contract from https://github.com/strenev/ERC721-Staking/blob/main/contracts/ERC721Staking.sol
...
contract ERC721Staking is ERC721Holder, ReentrancyGuard, Ownable, Pausable {
    ...
    // Stores the summation from 0 to b, R / L(t)
    mapping(address => uint256) public userRewardPerTokenPaid;

    // Stores rewards for a user
    ...
    function hasTokensStaked(address user) public view returns (bool) {
